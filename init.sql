...
create table clients (id_client SERIAL primary key, nom text, prenom text, adresse text, mail text not null, mdp text not null);
...
INSERT INTO commandes_details VALUES
(0, 0, 'CHEESY BREAD', '#', 4),
(1, 0, 'CHEESY BREAD1', '#', 4),
(2, 1, 'CHEESY BREAD2', '#', 4),
(3, 2, 'CHEESY BREAD3', '#', 4);
